...
public class MagierInfo extends JFrame {
	
	JPanel panel = new JPanel();
	JLabel info = new JLabel("Informationen zum Magier:");
	JLabel text = new JLabel("Magier sind experten im Umgang mit Tränken!");
	JLabel text2 = new JLabel("Du startest mit 2 extra Tränken!");
	JLabel text3 = new JLabel("Deine Tränke heilen mehr!");
